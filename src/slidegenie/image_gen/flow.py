"""Flow (process/timeline) image generator.

Ported from: ppt-addin/backend/services/make_pptx/image_gen/image/make_flow.py
"""
...
class FlowImageGenerator:
    ...
    def build_image_prompt(self) -> str:
        template_name = resolve_image_prompt_template(
            ...
            addin_en_template="make_flowimage_en",
            addin_ja_template="make_flowimage_ja",
        )
        return load_prompt(
            template_name,
            prompt=self.prompt,
